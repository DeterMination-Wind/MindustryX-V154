...
public abstract class InputHandler implements InputProcessor, GestureListener{
    ...
    public void update(){
        ...
        // Keep selected placement state in sync for snapshot packets.
    ...
    public void rotatePlans(Seq<BuildPlan> plans, int direction){
        ...
        plans.each(plan -> {
            ...
            if(LogicExt.rotateCanvas.get() && plan.block instanceof CanvasBlock cb){
                CanvasBlock.CanvasBuild temp = cb.new CanvasBuild();
                Pixmap pix = new Pixmap(cb.canvasSize, cb.canvasSize), pix2 = new Pixmap(cb.canvasSize, cb.canvasSize);
