...
public class CustomRulesDialog extends BaseDialog{
    ...
    public CustomRulesDialog(boolean showRuleEditRule){
        ...
        buttons.button("@edit", Icon.pencil, () -> {
            ...
            dialog.cont.table(Tex.button, t -> {
                ...
                t.defaults().size(280f, 64f).maxWidth(Float.NEGATIVE_INFINITY).pad(2f);
    ...
    public void team(String text, Cons<Team> cons, Prov<Team> prov){
        ...
        current.table(t -> {
            ...
            t.button(Icon.add, Styles.squareTogglei, 38f, () -> UIExt.teamSelect.pickOne(cons, prov.get())).pad(1f).checked(b -> !Seq.with(Team.baseTeams).contains(prov.get())).size(60f).tooltip("更多队伍选择");
        }).padTop(0).row();
    }
