...
public class MenuFragment{
    ...
    public void build(Group parent){
        ...
        parent.fill((x, y, w, h) -> {
            if(img.getDrawable() == null) renderer.render();
        });
...
//        }}, ui.discord::show).marginTop(9f).marginLeft(10f).tooltip("@discord").size(84, 45).name("discord"));
        ...
        parent.fill(c -> c.bottom().left().table(t -> {
            ...
            t.button("\uE83D", Styles.cleart, ()->ArcOld.nextBackground(img)).width(50f);
        }).visible(() -> !ArcOld.backgroundPath.get().isEmpty()).left().width(100));
